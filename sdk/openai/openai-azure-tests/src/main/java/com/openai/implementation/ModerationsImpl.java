...
public final class ModerationsImpl {
    ...
    ModerationsImpl(OpenAIClientImpl client) {
        this.service
            = RestProxy.create(ModerationsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    @ServiceInterface(name = "OpenAIClientModerati")
    public interface ModerationsService {
        ...
        Mono<Response<BinaryData>> createModeration(@HeaderParam("accept") String accept,
     ...
     *                 illicit: Boolean (Optional)
     *                 illicit/violent: Boolean (Optional)
     ...
     *                 illicit: Double (Optional)
     *                 illicit/violent: Double (Optional)
    ...
    public Mono<Response<BinaryData>> createModerationWithResponseAsync(BinaryData requestBody,
        ...
        return FluxUtil.withContext(context -> service.createModeration(accept, requestBody, requestOptions, context));
    }
    ...
    public Response<BinaryData> createModerationWithResponse(BinaryData requestBody, RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.createModerationSync(accept, requestBody, requestOptions, Context.NONE);
    }
}
