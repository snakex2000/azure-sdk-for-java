...
public final class CreateModerationResponseResultCategoryScores
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeNumberField("illicit", this.illicit);
        jsonWriter.writeNumberField("illicit/violent", this.illicitViolent);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("hate".equals(fieldName)) {
                    ...
                    illicit = reader.getNullable(JsonReader::getDouble);
                } else if ("illicit/violent".equals(fieldName)) {
                    illicitViolent = reader.getNullable(JsonReader::getDouble);
                } else {
                    reader.skipChildren();
                }
            }
            CreateModerationResponseResultCategoryScores deserializedCreateModerationResponseResultCategoryScores
                = new CreateModerationResponseResultCategoryScores(hate, hateThreatening, harassment,
                    harassmentThreatening, selfHarm, selfHarmIntent, selfHarmInstructions, sexual, sexualMinors,
                    violence, violenceGraphic);
            deserializedCreateModerationResponseResultCategoryScores.illicit = illicit;
            deserializedCreateModerationResponseResultCategoryScores.illicitViolent = illicitViolent;

            return deserializedCreateModerationResponseResultCategoryScores;
        });
    }
}
