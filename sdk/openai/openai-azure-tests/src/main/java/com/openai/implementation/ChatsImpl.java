...
public final class ChatsImpl {
    ...
    @ServiceInterface(name = "OpenAIClientChats")
    public interface ChatsService {
        ...
        Mono<Response<BinaryData>> createChatCompletion(@HeaderParam("accept") String accept,
    ...
    public Mono<Response<BinaryData>> createChatCompletionWithResponseAsync(BinaryData requestBody,
        ...
        return FluxUtil
            .withContext(context -> service.createChatCompletion(accept, requestBody, requestOptions, context));
    }
    ...
    public Response<BinaryData> createChatCompletionWithResponse(BinaryData requestBody,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.createChatCompletionSync(accept, requestBody, requestOptions, Context.NONE);
    }
}
