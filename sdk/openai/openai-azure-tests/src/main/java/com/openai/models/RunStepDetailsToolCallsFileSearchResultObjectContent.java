...
public final class RunStepDetailsToolCallsFileSearchResultObjectContent
     ...
     */
    @Generated
    private CreateTranscriptionRequestResponseFormat9 type;
     ...
     */
    @Generated
    public CreateTranscriptionRequestResponseFormat9 getType() {
        return this.type;
    }
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("type".equals(fieldName)) {
                    deserializedRunStepDetailsToolCallsFileSearchResultObjectContent.type
                        = CreateTranscriptionRequestResponseFormat9.fromString(reader.getString());
