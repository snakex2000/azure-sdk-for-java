...
public final class FilesImpl {
    ...
    @ServiceInterface(name = "OpenAIClientFiles")
    public interface FilesService {
        ...
        Mono<Response<BinaryData>> createFile(@HeaderParam("accept") String accept,
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> createFileSync(@HeaderParam("accept") String accept,
            @HeaderParam("content-type") String contentType, @BodyParam("multipart/form-data") BinaryData requestBody,
            RequestOptions requestOptions, Context context);
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<BinaryData>> listFiles(@HeaderParam("accept") String accept, RequestOptions requestOptions,
            Context context);
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<BinaryData>> retrieveFile(@HeaderParam("accept") String accept,
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> retrieveFileSync(@HeaderParam("accept") String accept, @PathParam("file_id") String fileId,
            RequestOptions requestOptions, Context context);
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<BinaryData>> deleteFile(@HeaderParam("accept") String accept, @PathParam("file_id") String fileId,
            RequestOptions requestOptions, Context context);
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> deleteFileSync(@HeaderParam("accept") String accept, @PathParam("file_id") String fileId,
            RequestOptions requestOptions, Context context);
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<BinaryData>> downloadFile(@HeaderParam("accept") String accept,
            @PathParam("file_id") String fileId, RequestOptions requestOptions, Context context);
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> downloadFileSync(@HeaderParam("accept") String accept, @PathParam("file_id") String fileId,
            RequestOptions requestOptions, Context context);
    }
    ...
    public Mono<Response<BinaryData>> createFileWithResponseAsync(BinaryData requestBody,
        ...
        return FluxUtil
            .withContext(context -> service.createFile(accept, contentType, requestBody, requestOptions, context));
    }
    ...
    public Response<BinaryData> createFileWithResponse(BinaryData requestBody, RequestOptions requestOptions) {
        final String accept = "application/json";
        final String contentType = "multipart/form-data";
        return service.createFileSync(accept, contentType, requestBody, requestOptions, Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> listFilesWithResponseAsync(RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.listFiles(accept, requestOptions, context));
    }
    ...
    public Mono<Response<BinaryData>> retrieveFileWithResponseAsync(String fileId, RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.retrieveFile(accept, fileId, requestOptions, context));
    }
    ...
    public Response<BinaryData> retrieveFileWithResponse(String fileId, RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.retrieveFileSync(accept, fileId, requestOptions, Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> deleteFileWithResponseAsync(String fileId, RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.deleteFile(accept, fileId, requestOptions, context));
    }
    ...
    public Response<BinaryData> deleteFileWithResponse(String fileId, RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.deleteFileSync(accept, fileId, requestOptions, Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> downloadFileWithResponseAsync(String fileId, RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.downloadFile(accept, fileId, requestOptions, context));
    }
    ...
    public Response<BinaryData> downloadFileWithResponse(String fileId, RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.downloadFileSync(accept, fileId, requestOptions, Context.NONE);
    }
}
