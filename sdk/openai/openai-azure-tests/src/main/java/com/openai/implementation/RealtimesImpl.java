 ...
 */
public final class RealtimesImpl {
    /**
    ...
    public interface RealtimesService {
        ...
        Mono<Response<BinaryData>> startRealtimeSession(@HeaderParam("accept") String accept,
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> startRealtimeSessionSync(@HeaderParam("accept") String accept,
            @BodyParam("application/json") BinaryData requestMessages, RequestOptions requestOptions, Context context);
    }
    ...
    public Mono<Response<BinaryData>> startRealtimeSessionWithResponseAsync(BinaryData requestMessages,
        ...
        return FluxUtil
            .withContext(context -> service.startRealtimeSession(accept, requestMessages, requestOptions, context));
    }
    ...
    public Response<BinaryData> startRealtimeSessionWithResponse(BinaryData requestMessages,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.startRealtimeSessionSync(accept, requestMessages, requestOptions, Context.NONE);
    }
}
