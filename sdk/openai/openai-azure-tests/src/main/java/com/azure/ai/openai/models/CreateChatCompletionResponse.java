 ...
 */
@Immutable
public class CreateChatCompletionResponse implements JsonSerializable<CreateChatCompletionResponse> {
    /*
     ...
     */
    @Generated
    protected CreateChatCompletionResponse(String id, List<CreateChatCompletionResponseChoice> choices,
    ...
    /**
     * Set the serviceTier property: The service tier used for processing the request. This field is only included if
     * the `service_tier` parameter is specified in the request.
     * 
     * @param serviceTier the serviceTier value to set.
     * @return the CreateChatCompletionResponse object itself.
     */
    @Generated
    CreateChatCompletionResponse setServiceTier(CreateChatCompletionResponseServiceTier serviceTier) {
    ...
    /**
     * Set the systemFingerprint property: This fingerprint represents the backend configuration that the model runs
     * with.
     * 
     * Can be used in conjunction with the `seed` request parameter to understand when backend changes have been made
     * that might impact determinism.
     ...
     */
    @Generated
    CreateChatCompletionResponse setSystemFingerprint(String systemFingerprint) {
