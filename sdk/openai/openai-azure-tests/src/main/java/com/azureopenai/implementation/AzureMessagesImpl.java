...
public final class AzureMessagesImpl {
    ...
    public interface AzureMessagesService {
        ...
        Mono<Response<BinaryData>> createMessage(@HostParam("endpoint") String endpoint,
            @PathParam("thread_id") String threadId, @HeaderParam("accept") String accept,
    ...
    public Response<BinaryData> createMessageWithResponse(String threadId, BinaryData requestBody,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.createMessageSync(this.client.getEndpoint(), threadId, accept, requestBody, requestOptions,
            Context.NONE);
    }
}
