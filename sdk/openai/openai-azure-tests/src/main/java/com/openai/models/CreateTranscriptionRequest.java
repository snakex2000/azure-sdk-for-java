...
public final class CreateTranscriptionRequest {
     ...
     */
    @Generated
    private List<CreateTranscriptionRequestTimestampGranularity> timestampGranularities;
     ...
     */
    @Generated
    public CreateTranscriptionRequest setResponseFormat(AudioResponseFormat responseFormat) {
     ...
     */
    @Generated
    public List<CreateTranscriptionRequestTimestampGranularity> getTimestampGranularities() {
    ...
    public CreateTranscriptionRequest
        setTimestampGranularities(List<CreateTranscriptionRequestTimestampGranularity> timestampGranularities) {
