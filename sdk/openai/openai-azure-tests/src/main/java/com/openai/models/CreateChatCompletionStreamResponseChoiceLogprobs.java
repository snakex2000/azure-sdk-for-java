...
public final class CreateChatCompletionStreamResponseChoiceLogprobs
     ...
     */
    @Generated
    private CreateChatCompletionStreamResponseChoiceLogprobs(List<ChatCompletionTokenLogprob> content,
    ...
    public static CreateChatCompletionStreamResponseChoiceLogprobs fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            return new CreateChatCompletionStreamResponseChoiceLogprobs(content, refusal);
        });
    }
}
