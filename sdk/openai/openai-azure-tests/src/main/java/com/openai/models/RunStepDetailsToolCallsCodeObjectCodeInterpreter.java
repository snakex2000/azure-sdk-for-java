...
public final class RunStepDetailsToolCallsCodeObjectCodeInterpreter
     ...
     */
    @Generated
    private final List<RunStepDetailsToolCallsCodeObjectCodeInterpreterOutputsObject> outputs;
    ...
    private RunStepDetailsToolCallsCodeObjectCodeInterpreter(String input,
        List<RunStepDetailsToolCallsCodeObjectCodeInterpreterOutputsObject> outputs) {
        this.input = input;
