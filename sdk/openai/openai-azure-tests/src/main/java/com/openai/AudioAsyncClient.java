...
public final class AudioAsyncClient {
     ...
     */
    @Generated
    AudioAsyncClient(AudiosImpl serviceClient) {
     ...
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return represents a verbose json transcription response returned by model, based on the provided input on
     * successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<CreateTranscriptionResponseVerboseJson> createTranscription(CreateTranscriptionRequest requestBody) {
        ...
        return createTranscriptionWithResponse(new MultipartFormDataHelper(requestOptions)
            ...
            .map(protocolMethodData -> protocolMethodData.toObject(CreateTranscriptionResponseVerboseJson.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<CreateTranslationResponseVerboseJson> createTranslation(CreateTranslationRequest requestBody) {
        ...
        return createTranslationWithResponse(new MultipartFormDataHelper(requestOptions)
            ...
            .end()
            .getRequestBody(), requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(CreateTranslationResponseVerboseJson.class));
    }
}
