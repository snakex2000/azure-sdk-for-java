...
public final class CreateModerationResponseResultCategories
    ...
    public static CreateModerationResponseResultCategories fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            Boolean illicit = null;
            Boolean illicitViolent = null;
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("hate".equals(fieldName)) {
                    ...
                    illicit = reader.getNullable(JsonReader::getBoolean);
                } else if ("illicit/violent".equals(fieldName)) {
                    illicitViolent = reader.getNullable(JsonReader::getBoolean);
                } else {
                    reader.skipChildren();
                }
            }
            CreateModerationResponseResultCategories deserializedCreateModerationResponseResultCategories
                = new CreateModerationResponseResultCategories(hate, hateThreatening, harassment, harassmentThreatening,
                    selfHarm, selfHarmIntent, selfHarmInstructions, sexual, sexualMinors, violence, violenceGraphic);
            deserializedCreateModerationResponseResultCategories.illicit = illicit;
            deserializedCreateModerationResponseResultCategories.illicitViolent = illicitViolent;

            return deserializedCreateModerationResponseResultCategories;
        });
    }
}
