...
public final class CreateChatCompletionResponseChoice implements JsonSerializable<CreateChatCompletionResponseChoice> {
     ...
     */
    @Generated
    private final CreateChatCompletionResponseChoiceFinishReason finishReason;
     ...
     */
    @Generated
    private CreateChatCompletionResponseChoice(CreateChatCompletionResponseChoiceFinishReason finishReason, int index,
     ...
     */
    @Generated
    public CreateChatCompletionResponseChoiceFinishReason getFinishReason() {
    ...
    public static CreateChatCompletionResponseChoice fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            CreateChatCompletionResponseChoiceFinishReason finishReason = null;
            int index = 0;
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("finish_reason".equals(fieldName)) {
                    finishReason = CreateChatCompletionResponseChoiceFinishReason.fromString(reader.getString());
